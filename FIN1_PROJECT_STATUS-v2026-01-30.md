...
**Stand:** 2026-01-30
**Hinweis:** Für den aktuellsten Stand siehe `FIN1_PROJECT_STATUS-v2026-01-31.md`.
...
- **FAQ vollständig server-driven** (Categories/Items) inkl. Caching + Retry/Refresh UI.
...
- FAQs: komplett server-driven (Categories/Items) inkl. Caching + Retry/Refresh UI
