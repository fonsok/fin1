...
3. **Technische Spezifikation (Architektur/Backend/API/Datenmodell/Security)**
   ...
   - **Epic: Post-Onboarding Re-Consent** ✅ (2026-06): [`EPIC_POST_ONBOARDING_RE_CONSENT.md`](EPIC_POST_ONBOARDING_RE_CONSENT.md) · Abnahme: [`../RELEASE_ABNAHME_RE_CONSENT.md`](../RELEASE_ABNAHME_RE_CONSENT.md) · iOS-Release (Depot KAUFEN, Auth-Split): [`../RELEASE_IOS_2026-06-29_RECONSENT_DEPOT.md`](../RELEASE_IOS_2026-06-29_RECONSENT_DEPOT.md)
