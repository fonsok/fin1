...
- **Post-onboarding Re-Consent (2026-06):** Nach Device-Gate prüft iOS `getUserMe.requiredReConsents` (`ReConsentModalView`); Backend `getRequiredReConsents` + `productAccessGate` Version-Drift. Abnahme: [`Documentation/RELEASE_ABNAHME_RE_CONSENT.md`](RELEASE_ABNAHME_RE_CONSENT.md).
