...
import { getNavIconStyle } from './navIconStyles';
              ...
              return (
                ...
                >
                  <div className={iconShellClass}>
                    <NavIcon name={item.icon} className={iconStyle.icon} />
                  </div>
