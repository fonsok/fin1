...
const TICKET_STATUS_CHIP_DARK: Record<string, string> = {
  ...
  waiting_for_customer: 'bg-violet-500/20 text-violet-100 border-violet-400/70',
  escalated: 'bg-red-500/20 text-red-100 border-red-400/70',
...
const TICKET_STATUS_CHIP_LIGHT: Record<string, string> = {
  ...
  waiting_for_customer: 'bg-violet-100 text-violet-800 border-violet-400/70',
  escalated: 'bg-red-100 text-red-800 border-red-400/70',
