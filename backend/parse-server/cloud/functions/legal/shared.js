...
const DEFAULT_LEGAL_SNIPPETS_DE = [
  ...
  { id: 'doc_tax_note_customer_self_reports', title: 'Steuerhinweis Selbstabführung', content: 'Allgemein: Grundsätzlich wird Abgeltungssteuer nicht an Finanzamt überwiesen.', icon: 'percent' },
...
const DEFAULT_LEGAL_SNIPPETS_EN = [
  ...
  { id: 'doc_tax_note_customer_self_reports', title: 'Tax note (customer self-reports)', content: 'General: As a rule, capital gains tax (Abgeltungsteuer) is not transferred to the tax office.', icon: 'percent' },
