...
const parseServerConfig = {
  ...
  // For a secure setup we allow localhost + Docker private ranges by default.
  // If you want to use Parse Dashboard from your browser, prefer an SSH tunnel to localhost
  // and keep these ranges tight.
  //
  // Override via:
