...
final class TraderCollectionBillLegDisplayDataBuilderTests: XCTestCase {
    ...
    func testSellLegShowsVerkaufWithMetadataQuantity() {
        ...
        let metadata = TraderCollectionBillBelegMetadata(
            ...
            amount: BelegEURMoney(euro: 996.0),
            quantity: 400,
            price: 2.49,
            orderId: "sell-1",
            sellOrderId: "sell-1",
            ...
            fees: .init(
                ...
                exchangeFee: BelegEURMoney(euro: 1),
                foreignCosts: BelegEURMoney(euro: 1.5),
                totalFees: BelegEURMoney(euro: 7.5)
            ),
            totalWithFees: BelegEURMoney(euro: 988.5),
            valueDate: "15.06.26",
    ...
    func testSecondPartialSellLegShowsFullProgressWhenComplete() {
        ...
        let metadata = TraderCollectionBillBelegMetadata(
            ...
            symbol: "GS4GLEF",
            instrumentLine: "Put - Dow Jones (GS4GLEF)",
            amount: BelegEURMoney(euro: 2_400.0),
            quantity: 800,
            price: 3.0,
            orderId: "sell-2",
            sellOrderId: "sell-2",
            wkn: "GS4GLEF",
            fees: .init(
                orderFee: BelegEURMoney(euro: 12),
                exchangeFee: BelegEURMoney(euro: 0.5),
                foreignCosts: BelegEURMoney(euro: 2.5),
                totalFees: BelegEURMoney(euro: 15)
            ),
            totalWithFees: BelegEURMoney(euro: 2_385.0),
            valueDate: "15.06.26",
    ...
    func testBuyLegShowsKaufOnly() {
        ...
        let metadata = TraderCollectionBillBelegMetadata(
            ...
            symbol: "GS4GLEF",
            instrumentLine: nil,
            amount: BelegEURMoney(euro: 2_988.0),
            quantity: 1_200,
            price: 2.49,
            orderId: "buy-1",
            sellOrderId: nil,
            ...
            totalWithFees: BelegEURMoney(euro: 2_995.5),
            valueDate: "10.06.26",
