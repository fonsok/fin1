...
enum TermsOfServiceEnglishContent {
    ...
    static let regulatorySection = Section(
        ...
        **German Securities Trading Regulations:**
        The App operates in compliance with:
    ...
    static let accountSection = Section(
        ...
        **Account Balance:**
        ...
        - Balance Purpose: Account balances are for App use only (clarify whether demo or real funds where applicable)
        - Balance Limitations: Balances may be subject to App policies and regulatory requirements
        """,
    ...
    static let privacySection = Section(
        ...
        content: """
        **GDPR/DSGVO Compliance:**
        The App complies with GDPR and DSGVO. Please refer to our Privacy Policy for:
    ...
    static let specialSection = Section(
        ...
        **Demo/Simulation Accounts:**
        - Initial Balance: As configured by the App (often **€0.00** by default; demo promotions may differ)
