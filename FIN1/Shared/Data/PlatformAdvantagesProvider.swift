...
struct PlatformAdvantagesProvider {
    ...
    static let investorAdvantages: [String] = [
        "Bare figures led investing for everyone – wealth maximization with real-time strategies and personalized investments.",
        "Connects investors directly with highly experienced traders who always invest their own money as well.",
        "Provides complete transparency with real-time investment visibility.",
        "Offers flexible investment strategies including single or multiple investment approaches for risk management.",
        "Uses modern technology for instant updates and mobile access.",
        "Ensures secure transactions with industry-leading security measures.",
        "Proportional profit sharing with no hidden fees.",
        "Ability to diversify across multiple traders and strategies.",
        "Lower barriers to entry with accessible minimum investments compared to traditional asset management."
    ]

    // MARK: - Trader Advantages
