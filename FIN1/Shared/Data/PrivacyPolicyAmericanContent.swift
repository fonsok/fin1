...
enum PrivacyPolicyAmericanContent {
    ...
    static let legalBasisSection = Section(
        ...
        **C. Legitimate Business Interests:**
        ...
        - **Justification**: Platform security, service improvement, fraud prevention
    ...
    static let changesSection = Section(
        ...
        **C. Significant Changes:**
        ...
        We will inform you of any material changes to this Privacy Policy. Your continued use of the Platform after changes take effect constitutes acceptance of the updated policy.
        """,
