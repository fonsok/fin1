...
// MARK: - Name Change Request Status

/// Status for name change requests requiring re-KYC verification
/// Per GwG (German Money Laundering Act), name changes require complete re-verification
enum NameChangeRequestStatus: String, CaseIterable, Codable, Hashable {
