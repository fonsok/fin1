...
// MARK: - Investment Management Service Protocol
/// Defines the contract for investment reservation and status management
protocol InvestmentManagementServiceProtocol: ServiceLifecycle {
    /// Investment pools managed by this service
