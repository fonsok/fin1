...
extension SignUpData {
    ...
    // MARK: - Data Export for API (Codable DTO for Parse Cloud Functions)

    /// Snapshot of onboarding fields persisted to the backend (no passwords, no UIImage data).
    func savedOnboardingData() -> SavedOnboardingData {
        SavedOnboardingData(
