#!/usr/bin/env python3
"""
Apply exported legal sections JSON to Parse `TermsContent` objects.
...
This script:
- Updates the active TermsContent for each (documentType, language)
...
def apply_one(client: ParseClient, payload: dict) -> None:
    ...
    print(f"UPDATED {doc_type} {lang}: objectId={obj_id} sections={len(sections)}")
